...
use Seo\SchemaOrg\Properties\FollowActionProperties;
...
final class FollowAction extends Type implements FollowActionProperties
{
    ...
    {
        return $this->set('followee', $value);
    }
