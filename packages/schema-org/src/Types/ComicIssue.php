...
use Seo\SchemaOrg\Properties\ComicIssueProperties;
...
final class ComicIssue extends Type implements ComicIssueProperties
{
    ...
    {
        return $this->set('variantCover', $value);
    }
