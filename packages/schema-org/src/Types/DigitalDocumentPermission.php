...
use Seo\SchemaOrg\Properties\DigitalDocumentPermissionProperties;
use Seo\SchemaOrg\Properties\DigitalDocumentPermissionTypeProperties;
...
final class DigitalDocumentPermission extends Type implements DigitalDocumentPermissionProperties
{
    ...
    {
        return $this->set('permissionType', $value);
    }
