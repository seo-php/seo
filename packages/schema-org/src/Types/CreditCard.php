...
use Seo\SchemaOrg\Properties\PaymentMethodTypeProperties;
...
final class CreditCard extends Type implements CreditCardProperties
{
    ...
    {
        return $this->set('cashBack', $value);
    }
    ...
    {
        return $this->set('contactlessPayment', $value);
    }
    ...
    {
        return $this->set('floorLimit', $value);
    }
    ...
    {
        return $this->set('gracePeriod', $value);
    }
    ...
    {
        return $this->set('loanRepaymentForm', $value);
    }
    ...
    {
        return $this->set('loanTerm', $value);
    }
    ...
    {
        return $this->set('loanType', $value);
    }
    ...
    {
        return $this->set('monthlyMinimumRepaymentAmount', $value);
    }
    ...
    {
        return $this->set('paymentMethodType', $value);
    }
    ...
    {
        return $this->set('recourseLoan', $value);
    }
    ...
    {
        return $this->set('renegotiableLoan', $value);
    }
    ...
    {
        return $this->set('requiredCollateral', $value);
    }
