...
use Seo\SchemaOrg\Properties\MusicCompositionProperties;
...
final class MusicComposition extends Type implements MusicCompositionProperties
{
    ...
    {
        return $this->set('firstPerformance', $value);
    }
    ...
    {
        return $this->set('includedComposition', $value);
    }
    ...
    {
        return $this->set('iswcCode', $value);
    }
    ...
    {
        return $this->set('lyricist', $value);
    }
    ...
    {
        return $this->set('musicArrangement', $value);
    }
    ...
    {
        return $this->set('musicCompositionForm', $value);
    }
    ...
    {
        return $this->set('musicalKey', $value);
    }
    ...
    {
        return $this->set('recordedAs', $value);
    }
