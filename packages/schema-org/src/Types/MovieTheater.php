...
use Seo\SchemaOrg\Properties\MovieTheaterProperties;
...
final class MovieTheater extends Type implements MovieTheaterProperties
{
    ...
    {
        return $this->set('screenCount', $value);
    }
