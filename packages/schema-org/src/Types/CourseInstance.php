...
final class CourseInstance extends Type implements CourseInstanceProperties
{
    ...
    {
        return $this->set('courseMode', $value);
    }
    ...
    {
        return $this->set('courseSchedule', $value);
    }
    ...
    {
        return $this->set('courseWorkload', $value);
    }
    ...
    {
        return $this->set('instructor', $value);
    }
