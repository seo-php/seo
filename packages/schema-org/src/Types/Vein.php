...
use Seo\SchemaOrg\Properties\VeinProperties;
use Seo\SchemaOrg\Properties\VesselProperties;
use Seo\SchemaOrg\Type;

final class Vein extends Type implements VeinProperties
{
    ...
    {
        return $this->set('drainsTo', $value);
    }
    ...
    {
        return $this->set('tributary', $value);
    }
