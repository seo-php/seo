...
final class DrugStrength extends Type implements DrugStrengthProperties
{
    ...
    {
        return $this->set('availableIn', $value);
    }
    ...
    {
        return $this->set('strengthUnit', $value);
    }
    ...
    {
        return $this->set('strengthValue', $value);
    }
