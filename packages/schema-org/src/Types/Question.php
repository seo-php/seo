...
use Seo\SchemaOrg\Properties\AnswerProperties;
...
use Seo\SchemaOrg\Properties\QuestionProperties;
...
final class Question extends Type implements QuestionProperties
{
    ...
    {
        return $this->set('acceptedAnswer', $value);
    }
    ...
    {
        return $this->set('answerCount', $value);
    }
    ...
    {
        return $this->set('downvoteCount', $value);
    }
    ...
    {
        return $this->set('eduQuestionType', $value);
    }
    ...
    {
        return $this->set('parentItem', $value);
    }
    ...
    {
        return $this->set('sharedContent', $value);
    }
    ...
    {
        return $this->set('suggestedAnswer', $value);
    }
    ...
    {
        return $this->set('upvoteCount', $value);
    }
