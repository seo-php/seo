...
use Seo\SchemaOrg\Properties\MusicAlbumProductionTypeProperties;
use Seo\SchemaOrg\Properties\MusicAlbumProperties;
use Seo\SchemaOrg\Properties\MusicAlbumReleaseTypeProperties;
use Seo\SchemaOrg\Properties\MusicGroupProperties;
use Seo\SchemaOrg\Properties\MusicRecordingProperties;
use Seo\SchemaOrg\Properties\MusicReleaseProperties;
...
final class MusicAlbum extends Type implements MusicAlbumProperties
{
    ...
    {
        return $this->set('albumProductionType', $value);
    }
    ...
    {
        return $this->set('albumRelease', $value);
    }
    ...
    {
        return $this->set('albumReleaseType', $value);
    }
    ...
    {
        return $this->set('byArtist', $value);
    }
    ...
    {
        return $this->set('numTracks', $value);
    }
