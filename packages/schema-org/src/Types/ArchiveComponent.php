...
use Seo\SchemaOrg\Properties\ArchiveComponentProperties;
use Seo\SchemaOrg\Properties\ArchiveOrganizationProperties;
...
final class ArchiveComponent extends Type implements ArchiveComponentProperties
{
    ...
    {
        return $this->set('holdingArchive', $value);
    }
    ...
    {
        return $this->set('itemLocation', $value);
    }
