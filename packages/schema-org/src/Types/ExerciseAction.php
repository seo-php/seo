...
use Seo\SchemaOrg\Properties\DietProperties;
use Seo\SchemaOrg\Properties\DistanceProperties;
use Seo\SchemaOrg\Properties\EntryPointProperties;
use Seo\SchemaOrg\Properties\EventProperties;
use Seo\SchemaOrg\Properties\ExerciseActionProperties;
use Seo\SchemaOrg\Properties\ExercisePlanProperties;
...
use Seo\SchemaOrg\Properties\SportsActivityLocationProperties;
use Seo\SchemaOrg\Properties\SportsEventProperties;
use Seo\SchemaOrg\Properties\SportsTeamProperties;
use Seo\SchemaOrg\Properties\TextObjectProperties;
use Seo\SchemaOrg\Properties\ThingProperties;
use Seo\SchemaOrg\Properties\VirtualLocationProperties;
use Seo\SchemaOrg\Type;

final class ExerciseAction extends Type implements ExerciseActionProperties
{
    ...
    {
        return $this->set('exerciseCourse', $value);
    }
    ...
    {
        return $this->set('exercisePlan', $value);
    }
    ...
    {
        return $this->set('exerciseRelatedDiet', $value);
    }
    ...
    {
        return $this->set('exerciseType', $value);
    }
    ...
    {
        return $this->set('opponent', $value);
    }
    ...
    {
        return $this->set('sportsActivityLocation', $value);
    }
    ...
    {
        return $this->set('sportsEvent', $value);
    }
    ...
    {
        return $this->set('sportsTeam', $value);
    }
