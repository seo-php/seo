...
use Seo\SchemaOrg\Properties\DrugCostCategoryProperties;
use Seo\SchemaOrg\Properties\DrugCostProperties;
...
final class DrugCost extends Type implements DrugCostProperties
{
    ...
    {
        return $this->set('applicableLocation', $value);
    }
    ...
    {
        return $this->set('costCategory', $value);
    }
    ...
    {
        return $this->set('costCurrency', $value);
    }
    ...
    {
        return $this->set('costOrigin', $value);
    }
    ...
    {
        return $this->set('costPerUnit', $value);
    }
