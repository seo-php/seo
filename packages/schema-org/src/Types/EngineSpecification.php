...
final class EngineSpecification extends Type implements EngineSpecificationProperties
{
    ...
    {
        return $this->set('engineDisplacement', $value);
    }
    ...
    {
        return $this->set('enginePower', $value);
    }
    ...
    {
        return $this->set('engineType', $value);
    }
