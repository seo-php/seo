...
use Seo\SchemaOrg\Properties\HowToDirectionProperties;
...
final class HowToDirection extends Type implements HowToDirectionProperties
{
    ...
    {
        return $this->set('afterMedia', $value);
    }
    ...
    {
        return $this->set('beforeMedia', $value);
    }
    ...
    {
        return $this->set('duringMedia', $value);
    }
    ...
    {
        return $this->set('nextItem', $value);
    }
    ...
    {
        return $this->set('previousItem', $value);
    }
