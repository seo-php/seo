...
final class SportsEvent extends Type implements SportsEventProperties
{
    ...
    {
        return $this->set('awayTeam', $value);
    }
    ...
    {
        return $this->set('competitor', $value);
    }
    ...
    {
        return $this->set('homeTeam', $value);
    }
