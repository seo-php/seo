...
use Seo\SchemaOrg\Properties\BedDetailsProperties;
use Seo\SchemaOrg\Properties\BedTypeProperties;
...
use Seo\SchemaOrg\Properties\SingleFamilyResidenceProperties;
use Seo\SchemaOrg\Properties\TextObjectProperties;
use Seo\SchemaOrg\Type;

final class SingleFamilyResidence extends Type implements SingleFamilyResidenceProperties
{
    ...
    {
        return $this->set('accommodationCategory', $value);
    }
    ...
    {
        return $this->set('accommodationFloorPlan', $value);
    }
    ...
    {
        return $this->set('floorLevel', $value);
    }
    ...
    {
        return $this->set('occupancy', $value);
    }
    ...
    {
        return $this->set('permittedUsage', $value);
    }
    ...
    {
        return $this->set('yearBuilt', $value);
    }
}
