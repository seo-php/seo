...
use Seo\SchemaOrg\Properties\LymphaticVesselProperties;
...
final class LymphaticVessel extends Type implements LymphaticVesselProperties
{
    ...
    {
        return $this->set('originatesFrom', $value);
    }
    ...
    {
        return $this->set('regionDrained', $value);
    }
