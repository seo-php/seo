...
final class AggregateOffer extends Type implements AggregateOfferProperties
{
    ...
    {
        return $this->set('highPrice', $value);
    }
    ...
    {
        return $this->set('lowPrice', $value);
    }
    ...
    {
        return $this->set('offerCount', $value);
    }
