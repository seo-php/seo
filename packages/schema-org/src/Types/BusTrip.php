...
use Seo\SchemaOrg\Properties\BusStationProperties;
use Seo\SchemaOrg\Properties\BusStopProperties;
use Seo\SchemaOrg\Properties\BusTripProperties;
...
final class BusTrip extends Type implements BusTripProperties
{
    ...
    {
        return $this->set('arrivalBusStop', $value);
    }
    ...
    {
        return $this->set('busNumber', $value);
    }
    ...
    {
        return $this->set('departureBusStop', $value);
    }
