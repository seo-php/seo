...
use Seo\SchemaOrg\Properties\MusicReleaseFormatTypeProperties;
...
final class MusicRelease extends Type implements MusicReleaseProperties
{
    ...
    {
        return $this->set('catalogNumber', $value);
    }
    ...
    {
        return $this->set('creditedTo', $value);
    }
    ...
    {
        return $this->set('musicReleaseFormat', $value);
    }
    ...
    {
        return $this->set('recordLabel', $value);
    }
    ...
    {
        return $this->set('releaseOf', $value);
    }
