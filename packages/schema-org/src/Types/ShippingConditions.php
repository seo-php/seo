...
use Seo\SchemaOrg\Properties\ShippingConditionsProperties;
use Seo\SchemaOrg\Properties\ShippingRateSettingsProperties;
use Seo\SchemaOrg\Properties\TextObjectProperties;
use Seo\SchemaOrg\Type;

final class ShippingConditions extends Type implements ShippingConditionsProperties
{
    ...
    {
        return $this->set('numItems', $value);
    }
    ...
    {
        return $this->set('orderValue', $value);
    }
    ...
    {
        return $this->set('seasonalOverride', $value);
    }
