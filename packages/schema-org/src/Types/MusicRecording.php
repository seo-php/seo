...
use Seo\SchemaOrg\Properties\MusicPlaylistProperties;
...
final class MusicRecording extends Type implements MusicRecordingProperties
{
    ...
    {
        return $this->set('inPlaylist', $value);
    }
    ...
    {
        return $this->set('isrcCode', $value);
    }
    ...
    {
        return $this->set('recordingOf', $value);
    }
