...
use Seo\SchemaOrg\Properties\MedicalObservationalStudyDesignProperties;
use Seo\SchemaOrg\Properties\MedicalObservationalStudyProperties;
...
final class MedicalObservationalStudy extends Type implements MedicalObservationalStudyProperties
{
    ...
    {
        return $this->set('studyDesign', $value);
    }
    ...
    {
        return $this->set('studyLocation', $value);
    }
    ...
    {
        return $this->set('studySubject', $value);
    }
