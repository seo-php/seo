...
use Seo\SchemaOrg\Properties\CompleteDataFeedProperties;
use Seo\SchemaOrg\Properties\CorrectionCommentProperties;
use Seo\SchemaOrg\Properties\CountryProperties;
use Seo\SchemaOrg\Properties\CreativeWorkProperties;
use Seo\SchemaOrg\Properties\DataCatalogProperties;
use Seo\SchemaOrg\Properties\DataDownloadProperties;
use Seo\SchemaOrg\Properties\DataFeedItemProperties;
...
final class CompleteDataFeed extends Type implements CompleteDataFeedProperties
{
    ...
    {
        return $this->set('dataFeedElement', $value);
    }
    ...
    {
        return $this->set('datasetTimeInterval', $value);
    }
    ...
    {
        return $this->set('distribution', $value);
    }
    ...
    {
        return $this->set('includedDataCatalog', $value);
    }
    ...
    {
        return $this->set('includedInDataCatalog', $value);
    }
    ...
    {
        return $this->set('variablesMeasured', $value);
    }
