...
use Seo\SchemaOrg\Properties\CivicStructureProperties;
...
use Seo\SchemaOrg\Properties\DatasetProperties;
...
use Seo\SchemaOrg\Properties\GovernmentServiceProperties;
...
use Seo\SchemaOrg\Properties\LocalBusinessProperties;
...
use Seo\SchemaOrg\Properties\SpecialAnnouncementProperties;
...
final class SpecialAnnouncement extends Type implements SpecialAnnouncementProperties
{
    ...
    {
        return $this->set('announcementLocation', $value);
    }
    ...
    {
        return $this->set('diseasePreventionInfo', $value);
    }
    ...
    {
        return $this->set('diseaseSpreadStatistics', $value);
    }
    ...
    {
        return $this->set('gettingTestedInfo', $value);
    }
    ...
    {
        return $this->set('governmentBenefitsInfo', $value);
    }
    ...
    {
        return $this->set('newsUpdatesAndGuidelines', $value);
    }
    ...
    {
        return $this->set('publicTransportClosuresInfo', $value);
    }
    ...
    {
        return $this->set('quarantineGuidelines', $value);
    }
    ...
    {
        return $this->set('schoolClosuresInfo', $value);
    }
    ...
    {
        return $this->set('travelBans', $value);
    }
