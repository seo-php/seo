...
use Seo\SchemaOrg\Properties\NewsMediaOrganizationProperties;
...
final class NewsMediaOrganization extends Type implements NewsMediaOrganizationProperties
{
    ...
    {
        return $this->set('masthead', $value);
    }
    ...
    {
        return $this->set('missionCoveragePrioritiesPolicy', $value);
    }
    ...
    {
        return $this->set('noBylinesPolicy', $value);
    }
    ...
    {
        return $this->set('verificationFactCheckingPolicy', $value);
    }
}
