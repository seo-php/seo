...
use Seo\SchemaOrg\Properties\ChemicalSubstanceProperties;
...
final class ChemicalSubstance extends Type implements ChemicalSubstanceProperties
{
    ...
    {
        return $this->set('chemicalComposition', $value);
    }
