...
final class Claim extends Type implements ClaimProperties
{
    ...
    {
        return $this->set('appearance', $value);
    }
    ...
    {
        return $this->set('claimInterpreter', $value);
    }
    ...
    {
        return $this->set('firstAppearance', $value);
    }
