...
final class OccupationalExperienceRequirements extends Type implements OccupationalExperienceRequirementsProperties
{
    ...
    {
        return $this->set('monthsOfExperience', $value);
    }
