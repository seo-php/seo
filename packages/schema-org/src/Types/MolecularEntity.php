...
use Seo\SchemaOrg\Properties\MolecularEntityProperties;
...
final class MolecularEntity extends Type implements MolecularEntityProperties
{
    ...
    {
        return $this->set('chemicalRole', $value);
    }
    ...
    {
        return $this->set('inChIKey', $value);
    }
    ...
    {
        return $this->set('iupacName', $value);
    }
    ...
    {
        return $this->set('molecularFormula', $value);
    }
    ...
    {
        return $this->set('molecularWeight', $value);
    }
    ...
    {
        return $this->set('monoisotopicMolecularWeight', $value);
    }
    ...
    {
        return $this->set('potentialUse', $value);
    }
