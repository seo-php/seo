...
use Seo\SchemaOrg\Properties\RsvpActionProperties;
use Seo\SchemaOrg\Properties\RsvpResponseTypeProperties;
use Seo\SchemaOrg\Properties\TextObjectProperties;
use Seo\SchemaOrg\Properties\ThingProperties;
use Seo\SchemaOrg\Properties\VirtualLocationProperties;
use Seo\SchemaOrg\Type;

final class RsvpAction extends Type implements RsvpActionProperties
{
    ...
    {
        return $this->set('additionalNumberOfGuests', $value);
    }
    ...
    {
        return $this->set('rsvpResponse', $value);
    }
