...
use Seo\SchemaOrg\Properties\TaxiReservationProperties;
use Seo\SchemaOrg\Properties\TextObjectProperties;
use Seo\SchemaOrg\Properties\ThingProperties;
use Seo\SchemaOrg\Properties\TicketProperties;
use Seo\SchemaOrg\Type;

final class TaxiReservation extends Type implements TaxiReservationProperties
{
    ...
    {
        return $this->set('partySize', $value);
    }
