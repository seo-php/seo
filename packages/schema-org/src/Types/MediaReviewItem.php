...
use Seo\SchemaOrg\Properties\MediaReviewItemProperties;
...
final class MediaReviewItem extends Type implements MediaReviewItemProperties
{
    ...
    {
        return $this->set('mediaItemAppearance', $value);
    }
