...
use Seo\SchemaOrg\Properties\MedicalTrialDesignProperties;
use Seo\SchemaOrg\Properties\MedicalTrialProperties;
...
final class MedicalTrial extends Type implements MedicalTrialProperties
{
    ...
    {
        return $this->set('trialDesign', $value);
    }
