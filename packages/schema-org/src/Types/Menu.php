...
use Seo\SchemaOrg\Properties\MenuSectionProperties;
...
final class Menu extends Type implements MenuProperties
{
    ...
    {
        return $this->set('hasMenuItem', $value);
    }
    ...
    {
        return $this->set('hasMenuSection', $value);
    }
