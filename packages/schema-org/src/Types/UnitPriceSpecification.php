...
use Seo\SchemaOrg\Properties\PriceComponentTypeEnumerationProperties;
use Seo\SchemaOrg\Properties\PriceSpecificationProperties;
use Seo\SchemaOrg\Properties\PriceTypeEnumerationProperties;
...
final class UnitPriceSpecification extends Type implements UnitPriceSpecificationProperties
{
    ...
    {
        return $this->set('billingDuration', $value);
    }
    ...
    {
        return $this->set('billingIncrement', $value);
    }
    ...
    {
        return $this->set('billingStart', $value);
    }
    ...
    {
        return $this->set('priceComponentType', $value);
    }
    ...
    {
        return $this->set('priceType', $value);
    }
    ...
    {
        return $this->set('referenceQuantity', $value);
    }
