...
use Seo\SchemaOrg\Properties\TVEpisodeProperties;
...
final class TVEpisode extends Type implements TVEpisodeProperties
{
    ...
    {
        return $this->set('episodeNumber', $value);
    }
    ...
    {
        return $this->set('subtitleLanguage', $value);
    }
    ...
    {
        return $this->set('titleEIDR', $value);
    }
