...
final class Gene extends Type implements GeneProperties
{
    ...
    {
        return $this->set('alternativeOf', $value);
    }
    ...
    {
        return $this->set('encodesBioChemEntity', $value);
    }
    ...
    {
        return $this->set('expressedIn', $value);
    }
