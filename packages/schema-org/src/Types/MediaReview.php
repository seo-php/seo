...
use Seo\SchemaOrg\Properties\MediaManipulationRatingEnumerationProperties;
use Seo\SchemaOrg\Properties\MediaObjectProperties;
use Seo\SchemaOrg\Properties\MediaReviewProperties;
...
final class MediaReview extends Type implements MediaReviewProperties
{
    ...
    {
        return $this->set('associatedClaimReview', $value);
    }
    ...
    {
        return $this->set('associatedMediaReview', $value);
    }
    ...
    {
        return $this->set('associatedReview', $value);
    }
    ...
    {
        return $this->set('itemReviewed', $value);
    }
    ...
    {
        return $this->set('mediaAuthenticityCategory', $value);
    }
    ...
    {
        return $this->set('originalMediaContextDescription', $value);
    }
    ...
    {
        return $this->set('originalMediaLink', $value);
    }
    ...
    {
        return $this->set('reviewAspect', $value);
    }
    ...
    {
        return $this->set('reviewBody', $value);
    }
    ...
    {
        return $this->set('reviewRating', $value);
    }
