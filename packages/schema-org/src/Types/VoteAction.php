...
use Seo\SchemaOrg\Properties\VoteActionProperties;
use Seo\SchemaOrg\Type;

final class VoteAction extends Type implements VoteActionProperties
{
    ...
    {
        return $this->set('actionOption', $value);
    }
    ...
    {
        return $this->set('candidate', $value);
    }
