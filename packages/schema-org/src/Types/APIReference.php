...
use Seo\SchemaOrg\Properties\APIReferenceProperties;
...
final class APIReference extends Type implements APIReferenceProperties
{
    ...
    {
        return $this->set('assembly', $value);
    }
    ...
    {
        return $this->set('assemblyVersion', $value);
    }
    ...
    {
        return $this->set('executableLibraryName', $value);
    }
    ...
    {
        return $this->set('proficiencyLevel', $value);
    }
    ...
    {
        return $this->set('programmingModel', $value);
    }
    ...
    {
        return $this->set('targetPlatform', $value);
    }
