...
final class DeliveryEvent extends Type implements DeliveryEventProperties
{
    ...
    {
        return $this->set('accessCode', $value);
    }
    ...
    {
        return $this->set('availableFrom', $value);
    }
    ...
    {
        return $this->set('availableThrough', $value);
    }
