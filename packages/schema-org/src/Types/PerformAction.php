...
use Seo\SchemaOrg\Properties\EntertainmentBusinessProperties;
...
use Seo\SchemaOrg\Properties\PerformActionProperties;
...
final class PerformAction extends Type implements PerformActionProperties
{
    ...
    {
        return $this->set('entertainmentBusiness', $value);
    }
