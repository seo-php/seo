...
use Seo\SchemaOrg\Properties\ImageObjectSnapshotProperties;
...
final class ImageObjectSnapshot extends Type implements ImageObjectSnapshotProperties
{
    ...
    {
        return $this->set('exifData', $value);
    }
    ...
    {
        return $this->set('representativeOfPage', $value);
    }
