...
use Seo\SchemaOrg\Properties\CorporationProperties;
...
final class Corporation extends Type implements CorporationProperties
{
    ...
    {
        return $this->set('tickerSymbol', $value);
    }
