...
use Seo\SchemaOrg\Properties\SiteNavigationElementProperties;
...
final class SiteNavigationElement extends Type implements SiteNavigationElementProperties
{
    ...
    {
        return $this->set('cssSelector', $value);
    }
