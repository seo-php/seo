...
use Seo\SchemaOrg\Properties\CertificationStatusEnumerationProperties;
...
final class Certification extends Type implements CertificationProperties
{
    ...
    {
        return $this->set('auditDate', $value);
    }
    ...
    {
        return $this->set('certificationIdentification', $value);
    }
    ...
    {
        return $this->set('certificationRating', $value);
    }
    ...
    {
        return $this->set('certificationStatus', $value);
    }
