...
use Seo\SchemaOrg\Properties\CreativeWorkSeasonProperties;
...
use Seo\SchemaOrg\Properties\EpisodeProperties;
...
use Seo\SchemaOrg\Properties\VideoGameSeriesProperties;
use Seo\SchemaOrg\Properties\VideoObjectProperties;
use Seo\SchemaOrg\Properties\WebPageProperties;
use Seo\SchemaOrg\Type;

final class VideoGameSeries extends Type implements VideoGameSeriesProperties
{
    ...
    {
        return $this->set('containsSeason', $value);
    }
    ...
    {
        return $this->set('episodes', $value);
    }
    ...
    {
        return $this->set('numberOfEpisodes', $value);
    }
    ...
    {
        return $this->set('numberOfSeasons', $value);
    }
