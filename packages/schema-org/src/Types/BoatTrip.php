...
use Seo\SchemaOrg\Properties\BoatTerminalProperties;
use Seo\SchemaOrg\Properties\BoatTripProperties;
...
final class BoatTrip extends Type implements BoatTripProperties
{
    ...
    {
        return $this->set('arrivalBoatTerminal', $value);
    }
    ...
    {
        return $this->set('departureBoatTerminal', $value);
    }
