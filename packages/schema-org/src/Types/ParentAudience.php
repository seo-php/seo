...
use Seo\SchemaOrg\Properties\ParentAudienceProperties;
use Seo\SchemaOrg\Properties\PropertyValueProperties;
use Seo\SchemaOrg\Properties\QuantitativeValueProperties;
use Seo\SchemaOrg\Properties\TextObjectProperties;
use Seo\SchemaOrg\Type;

final class ParentAudience extends Type implements ParentAudienceProperties
{
    ...
    {
        return $this->set('childMaxAge', $value);
    }
    ...
    {
        return $this->set('childMinAge', $value);
    }
