...
use Seo\SchemaOrg\Properties\SellActionProperties;
...
final class SellAction extends Type implements SellActionProperties
{
    ...
    {
        return $this->set('warrantyPromise', $value);
    }
}
