...
use Seo\SchemaOrg\Properties\JointProperties;
...
final class Joint extends Type implements JointProperties
{
    ...
    {
        return $this->set('biomechnicalClass', $value);
    }
    ...
    {
        return $this->set('functionalClass', $value);
    }
    ...
    {
        return $this->set('structuralClass', $value);
    }
