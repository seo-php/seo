...
use Seo\SchemaOrg\Properties\CourseInstanceProperties;
...
use Seo\SchemaOrg\Properties\SyllabusProperties;
...
final class Course extends Type implements CourseProperties
{
    ...
    {
        return $this->set('competencyRequired', $value);
    }
    ...
    {
        return $this->set('courseCode', $value);
    }
    ...
    {
        return $this->set('coursePrerequisites', $value);
    }
    ...
    {
        return $this->set('hasCourseInstance', $value);
    }
    ...
    {
        return $this->set('syllabusSections', $value);
    }
    ...
    {
        return $this->set('totalHistoricalEnrollment', $value);
    }
