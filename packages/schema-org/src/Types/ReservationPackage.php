...
use Seo\SchemaOrg\Properties\ReservationPackageProperties;
use Seo\SchemaOrg\Properties\ReservationProperties;
...
final class ReservationPackage extends Type implements ReservationPackageProperties
{
    ...
    {
        return $this->set('subReservation', $value);
    }
