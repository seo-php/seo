...
use Seo\SchemaOrg\Properties\CommentActionProperties;
...
final class CommentAction extends Type implements CommentActionProperties
{
    ...
    {
        return $this->set('resultComment', $value);
    }
