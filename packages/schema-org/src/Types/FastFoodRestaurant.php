...
use Seo\SchemaOrg\Properties\FastFoodRestaurantProperties;
...
use Seo\SchemaOrg\Properties\MenuProperties;
...
final class FastFoodRestaurant extends Type implements FastFoodRestaurantProperties
{
    ...
    {
        return $this->set('acceptsReservations', $value);
    }
    ...
    {
        return $this->set('servesCuisine', $value);
    }
    ...
    {
        return $this->set('starRating', $value);
    }
