...
use Seo\SchemaOrg\Properties\DepositAccountProperties;
...
final class DepositAccount extends Type implements DepositAccountProperties
{
    ...
    {
        return $this->set('accountMinimumInflow', $value);
    }
    ...
    {
        return $this->set('accountOverdraftLimit', $value);
    }
    ...
    {
        return $this->set('bankAccountType', $value);
    }
