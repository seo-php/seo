...
use Seo\SchemaOrg\Properties\ImagingTestProperties;
...
use Seo\SchemaOrg\Properties\MedicalImagingTechniqueProperties;
...
final class ImagingTest extends Type implements ImagingTestProperties
{
    ...
    {
        return $this->set('imagingTechnique', $value);
    }
