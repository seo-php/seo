...
use Seo\SchemaOrg\Properties\MathSolverProperties;
...
use Seo\SchemaOrg\Properties\SolveMathActionProperties;
...
final class MathSolver extends Type implements MathSolverProperties
{
    ...
    {
        return $this->set('mathExpression', $value);
    }
