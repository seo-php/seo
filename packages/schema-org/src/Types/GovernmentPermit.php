...
use Seo\SchemaOrg\Properties\GovernmentPermitProperties;
...
final class GovernmentPermit extends Type implements GovernmentPermitProperties
{
    ...
    {
        return $this->set('issuedThrough', $value);
    }
    ...
    {
        return $this->set('permitAudience', $value);
    }
