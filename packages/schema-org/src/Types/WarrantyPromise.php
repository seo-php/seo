...
use Seo\SchemaOrg\Properties\WarrantyScopeProperties;
use Seo\SchemaOrg\Type;

final class WarrantyPromise extends Type implements WarrantyPromiseProperties
{
    ...
    {
        return $this->set('durationOfWarranty', $value);
    }
    ...
    {
        return $this->set('warrantyScope', $value);
    }
}
