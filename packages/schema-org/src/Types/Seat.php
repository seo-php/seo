...
final class Seat extends Type implements SeatProperties
{
    ...
    {
        return $this->set('seatNumber', $value);
    }
    ...
    {
        return $this->set('seatSection', $value);
    }
    ...
    {
        return $this->set('seatingType', $value);
    }
