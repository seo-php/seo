...
final class SuperficialAnatomy extends Type implements SuperficialAnatomyProperties
{
    ...
    {
        return $this->set('relatedAnatomy', $value);
    }
    ...
    {
        return $this->set('significance', $value);
    }
