...
final class AnatomicalSystem extends Type implements AnatomicalSystemProperties
{
    ...
    {
        return $this->set('comprisedOf', $value);
    }
    ...
    {
        return $this->set('relatedStructure', $value);
    }
