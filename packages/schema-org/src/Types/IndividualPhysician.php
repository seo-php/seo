...
use Seo\SchemaOrg\Properties\HospitalProperties;
use Seo\SchemaOrg\Properties\ImageObjectProperties;
use Seo\SchemaOrg\Properties\IndividualPhysicianProperties;
...
use Seo\SchemaOrg\Properties\MedicalOrganizationProperties;
use Seo\SchemaOrg\Properties\MedicalProcedureProperties;
...
final class IndividualPhysician extends Type implements IndividualPhysicianProperties
{
    ...
    {
        return $this->set('availableService', $value);
    }
    ...
    {
        return $this->set('healthPlanNetworkId', $value);
    }
    ...
    {
        return $this->set('hospitalAffiliation', $value);
    }
    ...
    {
        return $this->set('isAcceptingNewPatients', $value);
    }
    ...
    {
        return $this->set('medicalSpecialty', $value);
    }
    ...
    {
        return $this->set('practicesAt', $value);
    }
