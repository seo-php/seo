...
use Seo\SchemaOrg\Properties\ClaimReviewProperties;
...
final class ClaimReview extends Type implements ClaimReviewProperties
{
    ...
    {
        return $this->set('claimReviewed', $value);
    }
