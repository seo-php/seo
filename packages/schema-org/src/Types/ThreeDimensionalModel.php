...
use Seo\SchemaOrg\Properties\ThreeDimensionalModelProperties;
use Seo\SchemaOrg\Properties\VideoObjectProperties;
use Seo\SchemaOrg\Properties\WebPageProperties;
use Seo\SchemaOrg\Type;

final class ThreeDimensionalModel extends Type implements ThreeDimensionalModelProperties
{
    ...
    {
        return $this->set('isResizable', $value);
    }
