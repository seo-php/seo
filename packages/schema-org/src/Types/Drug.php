...
use Seo\SchemaOrg\Properties\DoseScheduleProperties;
use Seo\SchemaOrg\Properties\DrugClassProperties;
use Seo\SchemaOrg\Properties\DrugLegalStatusProperties;
use Seo\SchemaOrg\Properties\DrugPregnancyCategoryProperties;
use Seo\SchemaOrg\Properties\DrugPrescriptionStatusProperties;
use Seo\SchemaOrg\Properties\DrugProperties;
use Seo\SchemaOrg\Properties\DrugStrengthProperties;
use Seo\SchemaOrg\Properties\EnergyConsumptionDetailsProperties;
use Seo\SchemaOrg\Properties\EventProperties;
use Seo\SchemaOrg\Properties\GrantProperties;
use Seo\SchemaOrg\Properties\HealthInsurancePlanProperties;
...
final class Drug extends Type implements DrugProperties
{
    ...
    {
        return $this->set('administrationRoute', $value);
    }
    ...
    {
        return $this->set('alcoholWarning', $value);
    }
    ...
    {
        return $this->set('availableStrength', $value);
    }
    ...
    {
        return $this->set('breastfeedingWarning', $value);
    }
    ...
    {
        return $this->set('clincalPharmacology', $value);
    }
    ...
    {
        return $this->set('clinicalPharmacology', $value);
    }
    ...
    {
        return $this->set('dosageForm', $value);
    }
    ...
    {
        return $this->set('doseSchedule', $value);
    }
    ...
    {
        return $this->set('drugClass', $value);
    }
    ...
    {
        return $this->set('drugUnit', $value);
    }
    ...
    {
        return $this->set('foodWarning', $value);
    }
    ...
    {
        return $this->set('includedInHealthInsurancePlan', $value);
    }
    ...
    {
        return $this->set('interactingDrug', $value);
    }
    ...
    {
        return $this->set('isAvailableGenerically', $value);
    }
    ...
    {
        return $this->set('labelDetails', $value);
    }
    ...
    {
        return $this->set('overdosage', $value);
    }
    ...
    {
        return $this->set('pregnancyCategory', $value);
    }
    ...
    {
        return $this->set('pregnancyWarning', $value);
    }
    ...
    {
        return $this->set('prescribingInfo', $value);
    }
    ...
    {
        return $this->set('prescriptionStatus', $value);
    }
    ...
    {
        return $this->set('relatedDrug', $value);
    }
