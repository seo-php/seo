...
final class ExercisePlan extends Type implements ExercisePlanProperties
{
    ...
    {
        return $this->set('activityDuration', $value);
    }
    ...
    {
        return $this->set('activityFrequency', $value);
    }
    ...
    {
        return $this->set('additionalVariable', $value);
    }
    ...
    {
        return $this->set('repetitions', $value);
    }
    ...
    {
        return $this->set('restPeriods', $value);
    }
    ...
    {
        return $this->set('workload', $value);
    }
}
