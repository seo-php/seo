...
use Seo\SchemaOrg\Properties\CompoundPriceSpecificationProperties;
...
final class CompoundPriceSpecification extends Type implements CompoundPriceSpecificationProperties
{
    ...
    {
        return $this->set('priceComponent', $value);
    }
