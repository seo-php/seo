...
use Seo\SchemaOrg\Properties\PublicationVolumeProperties;
...
final class PublicationVolume extends Type implements PublicationVolumeProperties
{
    ...
    {
        return $this->set('volumeNumber', $value);
    }
