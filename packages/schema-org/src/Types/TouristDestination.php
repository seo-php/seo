...
use Seo\SchemaOrg\Properties\TouristAttractionProperties;
use Seo\SchemaOrg\Properties\TouristDestinationProperties;
use Seo\SchemaOrg\Type;

final class TouristDestination extends Type implements TouristDestinationProperties
{
    ...
    {
        return $this->set('includesAttraction', $value);
    }
    ...
    {
        return $this->set('touristType', $value);
    }
