...
use Seo\SchemaOrg\Properties\EmployerAggregateRatingProperties;
...
final class EmployerAggregateRating extends Type implements EmployerAggregateRatingProperties
{
    ...
    {
        return $this->set('ratingCount', $value);
    }
    ...
    {
        return $this->set('ratingExplanation', $value);
    }
    ...
    {
        return $this->set('reviewCount', $value);
    }
