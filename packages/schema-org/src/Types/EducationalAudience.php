...
use Seo\SchemaOrg\Properties\EducationalAudienceProperties;
...
final class EducationalAudience extends Type implements EducationalAudienceProperties
{
    ...
    {
        return $this->set('educationalRole', $value);
    }
