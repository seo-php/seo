...
use Seo\SchemaOrg\Properties\VideoObjectSnapshotProperties;
use Seo\SchemaOrg\Properties\WebPageProperties;
use Seo\SchemaOrg\Type;

final class VideoObjectSnapshot extends Type implements VideoObjectSnapshotProperties
{
    ...
    {
        return $this->set('videoFrameSize', $value);
    }
    ...
    {
        return $this->set('videoQuality', $value);
    }
