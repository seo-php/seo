...
use Seo\SchemaOrg\Properties\ReportedDoseScheduleProperties;
use Seo\SchemaOrg\Properties\TextObjectProperties;
use Seo\SchemaOrg\Type;

final class ReportedDoseSchedule extends Type implements ReportedDoseScheduleProperties
{
    ...
    {
        return $this->set('doseUnit', $value);
    }
    ...
    {
        return $this->set('doseValue', $value);
    }
    ...
    {
        return $this->set('frequency', $value);
    }
