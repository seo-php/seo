...
use Seo\SchemaOrg\Properties\BlogProperties;
...
final class Blog extends Type implements BlogProperties
{
    ...
    {
        return $this->set('blogPost', $value);
    }
    ...
    {
        return $this->set('blogPosts', $value);
    }
