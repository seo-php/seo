...
use Seo\SchemaOrg\Properties\AudiobookProperties;
use Seo\SchemaOrg\Properties\BookFormatTypeProperties;
...
final class Audiobook extends Type implements AudiobookProperties
{
    ...
    {
        return $this->set('abridged', $value);
    }
    ...
    {
        return $this->set('bookEdition', $value);
    }
    ...
    {
        return $this->set('bookFormat', $value);
    }
    ...
    {
        return $this->set('embeddedTextCaption', $value);
    }
    ...
    {
        return $this->set('illustrator', $value);
    }
    ...
    {
        return $this->set('numberOfPages', $value);
    }
    ...
    {
        return $this->set('transcript', $value);
    }
