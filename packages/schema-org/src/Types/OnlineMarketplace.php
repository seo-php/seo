...
use Seo\SchemaOrg\Properties\OnlineMarketplaceProperties;
use Seo\SchemaOrg\Properties\OnlineStoreProperties;
...
final class OnlineMarketplace extends Type implements OnlineMarketplaceProperties
{
    ...
    {
        return $this->set('hasStore', $value);
    }
    ...
    {
        return $this->set('isStoreOn', $value);
    }
