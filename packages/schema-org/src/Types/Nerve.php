...
use Seo\SchemaOrg\Properties\BrainStructureProperties;
...
final class Nerve extends Type implements NerveProperties
{
    ...
    {
        return $this->set('nerveMotor', $value);
    }
    ...
    {
        return $this->set('sensoryUnit', $value);
    }
    ...
    {
        return $this->set('sourcedFrom', $value);
    }
