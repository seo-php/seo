...
use Seo\SchemaOrg\Properties\MedicalRiskCalculatorProperties;
...
final class MedicalRiskCalculator extends Type implements MedicalRiskCalculatorProperties
{
    ...
    {
        return $this->set('estimatesRiskOf', $value);
    }
    ...
    {
        return $this->set('includedRiskFactor', $value);
    }
