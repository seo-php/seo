...
use Seo\SchemaOrg\Properties\BreadcrumbListProperties;
...
use Seo\SchemaOrg\Properties\MedicalAudienceProperties;
use Seo\SchemaOrg\Properties\MedicalAudienceTypeProperties;
use Seo\SchemaOrg\Properties\MedicalWebPageProperties;
...
use Seo\SchemaOrg\Properties\SpecialtyProperties;
use Seo\SchemaOrg\Properties\TextObjectProperties;
use Seo\SchemaOrg\Properties\ThingProperties;
use Seo\SchemaOrg\Properties\VideoObjectProperties;
use Seo\SchemaOrg\Properties\WebPageElementProperties;
use Seo\SchemaOrg\Properties\WebPageProperties;
use Seo\SchemaOrg\Type;

final class MedicalWebPage extends Type implements MedicalWebPageProperties
{
    ...
    {
        return $this->set('lastReviewed', $value);
    }
    ...
    {
        return $this->set('mainContentOfPage', $value);
    }
    ...
    {
        return $this->set('medicalAudience', $value);
    }
    ...
    {
        return $this->set('primaryImageOfPage', $value);
    }
    ...
    {
        return $this->set('relatedLink', $value);
    }
    ...
    {
        return $this->set('reviewedBy', $value);
    }
    ...
    {
        return $this->set('significantLink', $value);
    }
    ...
    {
        return $this->set('significantLinks', $value);
    }
    ...
    {
        return $this->set('specialty', $value);
    }
