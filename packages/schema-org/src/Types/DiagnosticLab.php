...
use Seo\SchemaOrg\Properties\DiagnosticLabProperties;
...
final class DiagnosticLab extends Type implements DiagnosticLabProperties
{
    ...
    {
        return $this->set('availableTest', $value);
    }
