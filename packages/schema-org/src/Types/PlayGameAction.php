...
use Seo\SchemaOrg\Properties\GameAvailabilityEnumerationProperties;
...
use Seo\SchemaOrg\Properties\PlayGameActionProperties;
...
final class PlayGameAction extends Type implements PlayGameActionProperties
{
    ...
    {
        return $this->set('actionAccessibilityRequirement', $value);
    }
    ...
    {
        return $this->set('gameAvailabilityType', $value);
    }
