...
use Seo\SchemaOrg\Properties\RealEstateAgentProperties;
use Seo\SchemaOrg\Properties\RentActionProperties;
use Seo\SchemaOrg\Properties\TextObjectProperties;
use Seo\SchemaOrg\Properties\ThingProperties;
use Seo\SchemaOrg\Properties\VirtualLocationProperties;
use Seo\SchemaOrg\Type;

final class RentAction extends Type implements RentActionProperties
{
    ...
    {
        return $this->set('landlord', $value);
    }
    ...
    {
        return $this->set('realEstateAgent', $value);
    }
