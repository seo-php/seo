...
use Seo\SchemaOrg\Properties\GeoCircleProperties;
...
final class GeoCircle extends Type implements GeoCircleProperties
{
    ...
    {
        return $this->set('geoMidpoint', $value);
    }
    ...
    {
        return $this->set('geoRadius', $value);
    }
