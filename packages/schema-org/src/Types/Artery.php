...
use Seo\SchemaOrg\Properties\ArteryProperties;
...
final class Artery extends Type implements ArteryProperties
{
    ...
    {
        return $this->set('arterialBranch', $value);
    }
    ...
    {
        return $this->set('supplyTo', $value);
    }
