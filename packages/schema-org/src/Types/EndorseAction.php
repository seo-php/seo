...
use Seo\SchemaOrg\Properties\EndorseActionProperties;
...
final class EndorseAction extends Type implements EndorseActionProperties
{
    ...
    {
        return $this->set('endorsee', $value);
    }
