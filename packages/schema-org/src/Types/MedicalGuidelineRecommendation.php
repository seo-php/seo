...
use Seo\SchemaOrg\Properties\MedicalEvidenceLevelProperties;
use Seo\SchemaOrg\Properties\MedicalGuidelineProperties;
use Seo\SchemaOrg\Properties\MedicalGuidelineRecommendationProperties;
...
final class MedicalGuidelineRecommendation extends Type implements MedicalGuidelineRecommendationProperties
{
    ...
    {
        return $this->set('evidenceLevel', $value);
    }
    ...
    {
        return $this->set('evidenceOrigin', $value);
    }
    ...
    {
        return $this->set('guidelineDate', $value);
    }
    ...
    {
        return $this->set('guidelineSubject', $value);
    }
    ...
    {
        return $this->set('recommendationStrength', $value);
    }
