...
use Seo\SchemaOrg\Properties\PresentationDigitalDocumentProperties;
...
final class PresentationDigitalDocument extends Type implements PresentationDigitalDocumentProperties
{
    ...
    {
        return $this->set('hasDigitalDocumentPermission', $value);
    }
