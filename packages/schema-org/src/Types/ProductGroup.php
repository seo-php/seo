...
final class ProductGroup extends Type implements ProductGroupProperties
{
    ...
    {
        return $this->set('hasVariant', $value);
    }
    ...
    {
        return $this->set('productGroupID', $value);
    }
    ...
    {
        return $this->set('variesBy', $value);
    }
