...
use Seo\SchemaOrg\Properties\QuotationProperties;
...
final class Quotation extends Type implements QuotationProperties
{
    ...
    {
        return $this->set('spokenByCharacter', $value);
    }
