...
use Seo\SchemaOrg\Properties\WebApplicationProperties;
use Seo\SchemaOrg\Properties\WebPageProperties;
use Seo\SchemaOrg\Type;

final class WebApplication extends Type implements WebApplicationProperties
{
     ...
     * @param string|string[] $value
     */
    public function browserRequirements(mixed $value): static
    {
        return $this->set('browserRequirements', $value);
    }
