...
use Seo\SchemaOrg\Properties\BusOrCoachProperties;
...
final class BusOrCoach extends Type implements BusOrCoachProperties
{
    ...
    {
        return $this->set('acrissCode', $value);
    }
    ...
    {
        return $this->set('roofLoad', $value);
    }
