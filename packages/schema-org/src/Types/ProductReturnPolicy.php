...
final class ProductReturnPolicy extends Type implements ProductReturnPolicyProperties
{
    ...
    {
        return $this->set('productReturnDays', $value);
    }
    ...
    {
        return $this->set('productReturnLink', $value);
    }
