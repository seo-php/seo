...
use Seo\SchemaOrg\Properties\HowToSectionProperties;
use Seo\SchemaOrg\Properties\HowToStepProperties;
use Seo\SchemaOrg\Properties\HowToSupplyProperties;
use Seo\SchemaOrg\Properties\HowToToolProperties;
...
use Seo\SchemaOrg\Properties\RecipeProperties;
use Seo\SchemaOrg\Properties\RestrictedDietProperties;
...
final class Recipe extends Type implements RecipeProperties
{
    ...
    {
        return $this->set('cookTime', $value);
    }
    ...
    {
        return $this->set('cookingMethod', $value);
    }
    ...
    {
        return $this->set('estimatedCost', $value);
    }
    ...
    {
        return $this->set('ingredients', $value);
    }
    ...
    {
        return $this->set('nutrition', $value);
    }
    ...
    {
        return $this->set('performTime', $value);
    }
    ...
    {
        return $this->set('prepTime', $value);
    }
    ...
    {
        return $this->set('recipeCategory', $value);
    }
    ...
    {
        return $this->set('recipeCuisine', $value);
    }
    ...
    {
        return $this->set('recipeIngredient', $value);
    }
    ...
    {
        return $this->set('recipeInstructions', $value);
    }
    ...
    {
        return $this->set('recipeYield', $value);
    }
    ...
    {
        return $this->set('suitableForDiet', $value);
    }
    ...
    {
        return $this->set('totalTime', $value);
    }
