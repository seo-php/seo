...
use Seo\SchemaOrg\Properties\UserCommentsProperties;
use Seo\SchemaOrg\Properties\VirtualLocationProperties;
use Seo\SchemaOrg\Type;

final class UserComments extends Type implements UserCommentsProperties
{
    ...
    {
        return $this->set('commentTime', $value);
    }
    ...
    {
        return $this->set('discusses', $value);
    }
    ...
    {
        return $this->set('replyToUrl', $value);
    }
