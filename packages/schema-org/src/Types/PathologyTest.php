...
use Seo\SchemaOrg\Properties\PathologyTestProperties;
use Seo\SchemaOrg\Properties\PropertyValueProperties;
use Seo\SchemaOrg\Properties\TextObjectProperties;
use Seo\SchemaOrg\Type;

final class PathologyTest extends Type implements PathologyTestProperties
{
    ...
    {
        return $this->set('tissueSample', $value);
    }
