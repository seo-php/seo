...
final class OwnershipInfo extends Type implements OwnershipInfoProperties
{
    ...
    {
        return $this->set('acquiredFrom', $value);
    }
    ...
    {
        return $this->set('ownedFrom', $value);
    }
    ...
    {
        return $this->set('ownedThrough', $value);
    }
