...
use Seo\SchemaOrg\Properties\ExchangeRateSpecificationProperties;
...
final class ExchangeRateSpecification extends Type implements ExchangeRateSpecificationProperties
{
    ...
    {
        return $this->set('currentExchangeRate', $value);
    }
    ...
    {
        return $this->set('exchangeRateSpread', $value);
    }
