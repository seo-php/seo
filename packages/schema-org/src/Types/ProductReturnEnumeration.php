...
use Seo\SchemaOrg\Properties\ProductReturnEnumerationProperties;
use Seo\SchemaOrg\Properties\PropertyProperties;
use Seo\SchemaOrg\Properties\PropertyValueProperties;
use Seo\SchemaOrg\Properties\TextObjectProperties;
use Seo\SchemaOrg\Type;

final class ProductReturnEnumeration extends Type implements ProductReturnEnumerationProperties
{
    protected function type(): string
    {
        return 'ProductReturnEnumeration';
    }
