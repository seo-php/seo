...
use Seo\SchemaOrg\Properties\PaymentChargeSpecificationProperties;
...
final class PaymentChargeSpecification extends Type implements PaymentChargeSpecificationProperties
{
    ...
    {
        return $this->set('appliesToPaymentMethod', $value);
    }
