...
use Seo\SchemaOrg\Properties\InfectiousAgentClassProperties;
use Seo\SchemaOrg\Properties\InfectiousDiseaseProperties;
...
final class InfectiousDisease extends Type implements InfectiousDiseaseProperties
{
    ...
    {
        return $this->set('infectiousAgent', $value);
    }
    ...
    {
        return $this->set('infectiousAgentClass', $value);
    }
    ...
    {
        return $this->set('transmissionMethod', $value);
    }
