...
use Seo\SchemaOrg\Properties\VisualArtworkProperties;
use Seo\SchemaOrg\Properties\WebPageProperties;
use Seo\SchemaOrg\Type;

final class VisualArtwork extends Type implements VisualArtworkProperties
{
    ...
    {
        return $this->set('artEdition', $value);
    }
    ...
    {
        return $this->set('artMedium', $value);
    }
    ...
    {
        return $this->set('artworkSurface', $value);
    }
    ...
    {
        return $this->set('colorist', $value);
    }
    ...
    {
        return $this->set('letterer', $value);
    }
    ...
    {
        return $this->set('penciler', $value);
    }
