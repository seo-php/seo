...
use Seo\SchemaOrg\Properties\ReviewNewsArticleProperties;
...
final class ReviewNewsArticle extends Type implements ReviewNewsArticleProperties
{
    ...
    {
        return $this->set('dateline', $value);
    }
    ...
    {
        return $this->set('printColumn', $value);
    }
    ...
    {
        return $this->set('printEdition', $value);
    }
    ...
    {
        return $this->set('printPage', $value);
    }
    ...
    {
        return $this->set('printSection', $value);
    }
