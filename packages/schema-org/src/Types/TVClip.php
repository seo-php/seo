...
use Seo\SchemaOrg\Properties\CreativeWorkSeriesProperties;
...
use Seo\SchemaOrg\Properties\HyperTocEntryProperties;
...
use Seo\SchemaOrg\Properties\TVClipProperties;
use Seo\SchemaOrg\Properties\TVSeriesProperties;
...
final class TVClip extends Type implements TVClipProperties
{
    ...
    {
        return $this->set('clipNumber', $value);
    }
    ...
    {
        return $this->set('endOffset', $value);
    }
    ...
    {
        return $this->set('partOfEpisode', $value);
    }
    ...
    {
        return $this->set('partOfSeason', $value);
    }
    ...
    {
        return $this->set('partOfSeries', $value);
    }
    ...
    {
        return $this->set('partOfTVSeries', $value);
    }
