...
use Seo\SchemaOrg\Properties\ComputerLanguageProperties;
...
use Seo\SchemaOrg\Properties\SoftwareSourceCodeProperties;
...
final class SoftwareSourceCode extends Type implements SoftwareSourceCodeProperties
{
    ...
    {
        return $this->set('codeRepository', $value);
    }
    ...
    {
        return $this->set('codeSampleType', $value);
    }
    ...
    {
        return $this->set('programmingLanguage', $value);
    }
    ...
    {
        return $this->set('runtimePlatform', $value);
    }
    ...
    {
        return $this->set('sampleType', $value);
    }
    ...
    {
        return $this->set('targetProduct', $value);
    }
