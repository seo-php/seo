...
final class EducationalOccupationalCredential extends Type implements EducationalOccupationalCredentialProperties
{
    ...
    {
        return $this->set('credentialCategory', $value);
    }
    ...
    {
        return $this->set('recognizedBy', $value);
    }
    ...
    {
        return $this->set('validFor', $value);
    }
