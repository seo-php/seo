...
use Seo\SchemaOrg\Properties\ReviewActionProperties;
...
final class ReviewAction extends Type implements ReviewActionProperties
{
    ...
    {
        return $this->set('resultReview', $value);
    }
