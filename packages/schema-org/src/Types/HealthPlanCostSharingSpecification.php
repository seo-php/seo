...
use Seo\SchemaOrg\Properties\HealthPlanCostSharingSpecificationProperties;
...
final class HealthPlanCostSharingSpecification extends Type implements HealthPlanCostSharingSpecificationProperties
{
    ...
    {
        return $this->set('healthPlanCoinsuranceOption', $value);
    }
    ...
    {
        return $this->set('healthPlanCoinsuranceRate', $value);
    }
    ...
    {
        return $this->set('healthPlanCopay', $value);
    }
    ...
    {
        return $this->set('healthPlanCopayOption', $value);
    }
    ...
    {
        return $this->set('healthPlanPharmacyCategory', $value);
    }
