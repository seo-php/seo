...
use Seo\SchemaOrg\Properties\RentalCarReservationProperties;
...
final class RentalCarReservation extends Type implements RentalCarReservationProperties
{
    ...
    {
        return $this->set('dropoffLocation', $value);
    }
    ...
    {
        return $this->set('dropoffTime', $value);
    }
    ...
    {
        return $this->set('pickupLocation', $value);
    }
    ...
    {
        return $this->set('pickupTime', $value);
    }
