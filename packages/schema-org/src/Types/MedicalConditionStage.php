...
final class MedicalConditionStage extends Type implements MedicalConditionStageProperties
{
    ...
    {
        return $this->set('stageAsNumber', $value);
    }
    ...
    {
        return $this->set('subStageSuffix', $value);
    }
