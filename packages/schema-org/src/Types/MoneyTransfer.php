...
use Seo\SchemaOrg\Properties\BankOrCreditUnionProperties;
...
use Seo\SchemaOrg\Properties\MoneyTransferProperties;
...
final class MoneyTransfer extends Type implements MoneyTransferProperties
{
    ...
    {
        return $this->set('beneficiaryBank', $value);
    }
