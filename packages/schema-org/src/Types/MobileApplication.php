...
use Seo\SchemaOrg\Properties\MobileApplicationProperties;
...
final class MobileApplication extends Type implements MobileApplicationProperties
{
    ...
    {
        return $this->set('carrierRequirements', $value);
    }
