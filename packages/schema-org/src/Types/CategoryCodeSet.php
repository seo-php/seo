...
final class CategoryCodeSet extends Type implements CategoryCodeSetProperties
{
    ...
    {
        return $this->set('hasCategoryCode', $value);
    }
    ...
    {
        return $this->set('hasDefinedTerm', $value);
    }
