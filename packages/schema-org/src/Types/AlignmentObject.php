...
final class AlignmentObject extends Type implements AlignmentObjectProperties
{
    ...
    {
        return $this->set('alignmentType', $value);
    }
    ...
    {
        return $this->set('educationalFramework', $value);
    }
    ...
    {
        return $this->set('targetDescription', $value);
    }
    ...
    {
        return $this->set('targetName', $value);
    }
    ...
    {
        return $this->set('targetUrl', $value);
    }
