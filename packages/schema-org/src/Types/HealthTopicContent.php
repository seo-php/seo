...
use Seo\SchemaOrg\Properties\HealthAspectEnumerationProperties;
use Seo\SchemaOrg\Properties\HealthTopicContentProperties;
...
final class HealthTopicContent extends Type implements HealthTopicContentProperties
{
    ...
    {
        return $this->set('hasHealthAspect', $value);
    }
