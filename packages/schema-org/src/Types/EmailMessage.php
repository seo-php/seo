...
use Seo\SchemaOrg\Properties\EmailMessageProperties;
...
final class EmailMessage extends Type implements EmailMessageProperties
{
    ...
    {
        return $this->set('bccRecipient', $value);
    }
    ...
    {
        return $this->set('ccRecipient', $value);
    }
    ...
    {
        return $this->set('dateRead', $value);
    }
    ...
    {
        return $this->set('dateReceived', $value);
    }
    ...
    {
        return $this->set('messageAttachment', $value);
    }
    ...
    {
        return $this->set('toRecipient', $value);
    }
