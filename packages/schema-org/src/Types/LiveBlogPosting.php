...
use Seo\SchemaOrg\Properties\BlogPostingProperties;
...
use Seo\SchemaOrg\Properties\LiveBlogPostingProperties;
...
final class LiveBlogPosting extends Type implements LiveBlogPostingProperties
{
    ...
    {
        return $this->set('coverageEndTime', $value);
    }
    ...
    {
        return $this->set('coverageStartTime', $value);
    }
    ...
    {
        return $this->set('liveBlogUpdate', $value);
    }
