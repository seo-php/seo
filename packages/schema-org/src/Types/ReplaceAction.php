...
use Seo\SchemaOrg\Properties\ReplaceActionProperties;
use Seo\SchemaOrg\Properties\TextObjectProperties;
use Seo\SchemaOrg\Properties\ThingProperties;
use Seo\SchemaOrg\Properties\VirtualLocationProperties;
use Seo\SchemaOrg\Type;

final class ReplaceAction extends Type implements ReplaceActionProperties
{
    ...
    {
        return $this->set('replacee', $value);
    }
    ...
    {
        return $this->set('replacer', $value);
    }
    ...
    {
        return $this->set('targetCollection', $value);
    }
