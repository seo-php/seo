...
final class Diet extends Type implements DietProperties
{
    ...
    {
        return $this->set('dietFeatures', $value);
    }
    ...
    {
        return $this->set('endorsers', $value);
    }
    ...
    {
        return $this->set('expertConsiderations', $value);
    }
    ...
    {
        return $this->set('physiologicalBenefits', $value);
    }
