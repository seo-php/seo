...
use Seo\SchemaOrg\Properties\BroadcastEventProperties;
...
final class BroadcastEvent extends Type implements BroadcastEventProperties
{
    ...
    {
        return $this->set('broadcastOfEvent', $value);
    }
    ...
    {
        return $this->set('isLiveBroadcast', $value);
    }
    ...
    {
        return $this->set('publishedBy', $value);
    }
    ...
    {
        return $this->set('publishedOn', $value);
    }
