...
use Seo\SchemaOrg\Properties\HealthPlanFormularyProperties;
use Seo\SchemaOrg\Properties\HealthPlanNetworkProperties;
use Seo\SchemaOrg\Properties\ImageObjectProperties;
use Seo\SchemaOrg\Properties\PropertyValueProperties;
use Seo\SchemaOrg\Properties\TextObjectProperties;
use Seo\SchemaOrg\Type;

final class HealthInsurancePlan extends Type implements HealthInsurancePlanProperties
{
    ...
    {
        return $this->set('benefitsSummaryUrl', $value);
    }
    ...
    {
        return $this->set('healthPlanDrugOption', $value);
    }
    ...
    {
        return $this->set('healthPlanDrugTier', $value);
    }
    ...
    {
        return $this->set('healthPlanId', $value);
    }
    ...
    {
        return $this->set('healthPlanMarketingUrl', $value);
    }
    ...
    {
        return $this->set('includesHealthPlanFormulary', $value);
    }
    ...
    {
        return $this->set('includesHealthPlanNetwork', $value);
    }
    ...
    {
        return $this->set('usesHealthPlanIdStandard', $value);
    }
}
