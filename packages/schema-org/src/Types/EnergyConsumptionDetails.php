...
use Seo\SchemaOrg\Properties\EUEnergyEfficiencyEnumerationProperties;
use Seo\SchemaOrg\Properties\EnergyConsumptionDetailsProperties;
use Seo\SchemaOrg\Properties\EnergyEfficiencyEnumerationProperties;
...
final class EnergyConsumptionDetails extends Type implements EnergyConsumptionDetailsProperties
{
    ...
    {
        return $this->set('energyEfficiencyScaleMax', $value);
    }
    ...
    {
        return $this->set('energyEfficiencyScaleMin', $value);
    }
    ...
    {
        return $this->set('hasEnergyEfficiencyCategory', $value);
    }
