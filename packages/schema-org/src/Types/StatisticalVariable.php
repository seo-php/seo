...
final class StatisticalVariable extends Type implements StatisticalVariableProperties
{
    ...
    {
        return $this->set('constraintProperty', $value);
    }
    ...
    {
        return $this->set('numConstraints', $value);
    }
    ...
    {
        return $this->set('populationType', $value);
    }
    ...
    {
        return $this->set('statType', $value);
    }
