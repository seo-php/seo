...
use Seo\SchemaOrg\Properties\MortgageLoanProperties;
...
final class MortgageLoan extends Type implements MortgageLoanProperties
{
    ...
    {
        return $this->set('domiciledMortgage', $value);
    }
    ...
    {
        return $this->set('loanMortgageMandateAmount', $value);
    }
