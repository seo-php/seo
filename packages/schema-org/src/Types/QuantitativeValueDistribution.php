...
use Seo\SchemaOrg\Properties\QuantitativeValueDistributionProperties;
use Seo\SchemaOrg\Properties\QuantitativeValueProperties;
use Seo\SchemaOrg\Properties\TextObjectProperties;
use Seo\SchemaOrg\Type;

final class QuantitativeValueDistribution extends Type implements QuantitativeValueDistributionProperties
{
    ...
    {
        return $this->set('percentile10', $value);
    }
    ...
    {
        return $this->set('percentile25', $value);
    }
    ...
    {
        return $this->set('percentile75', $value);
    }
    ...
    {
        return $this->set('percentile90', $value);
    }
