...
final class Property extends Type implements PropertyProperties
{
    ...
    {
        return $this->set('domainIncludes', $value);
    }
    ...
    {
        return $this->set('inverseOf', $value);
    }
    ...
    {
        return $this->set('rangeIncludes', $value);
    }
