...
final class OrderItem extends Type implements OrderItemProperties
{
    ...
    {
        return $this->set('orderItemNumber', $value);
    }
    ...
    {
        return $this->set('orderItemStatus', $value);
    }
    ...
    {
        return $this->set('orderQuantity', $value);
    }
