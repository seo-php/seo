...
use Seo\SchemaOrg\Properties\FlightReservationProperties;
...
final class FlightReservation extends Type implements FlightReservationProperties
{
    ...
    {
        return $this->set('boardingGroup', $value);
    }
    ...
    {
        return $this->set('passengerPriorityStatus', $value);
    }
    ...
    {
        return $this->set('passengerSequenceNumber', $value);
    }
    ...
    {
        return $this->set('securityScreening', $value);
    }
