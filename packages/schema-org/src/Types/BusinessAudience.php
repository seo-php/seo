...
use Seo\SchemaOrg\Properties\BusinessAudienceProperties;
...
final class BusinessAudience extends Type implements BusinessAudienceProperties
{
    ...
    {
        return $this->set('yearlyRevenue', $value);
    }
    ...
    {
        return $this->set('yearsInOperation', $value);
    }
}
